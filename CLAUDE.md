...
A personal site and content tool the owner fully controls — publish pages and posts, capture leads and enquiries, and manage everything from a private dashboard on your own domain.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "296509147+JoGit55@users.noreply.github.com"
  git config user.name "JoGit55"
  ```
